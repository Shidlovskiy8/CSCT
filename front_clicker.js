...
// =================================================================
// 1. ИНЖЕКТОР КНОПКИ СБОРА ПОДАЧИ (Работает на страницах каталога)
// =================================================================
function initCatalogButtonInjector() {
    // На /additem кнопку рисовать не нужно
...
// Обработчик клика по кнопке в каталоге
function onCollectButtonClick(e) {
    ...
    // Сохраняем стек и флаг автоклика
...
// =================================================================
// 2. БЛОКИРОВКА РУЧНОГО СКРОЛЛА (ScrollLock)
// =================================================================
class ScrollLock {
...
// =================================================================
// 4. ВСПОМОГАТЕЛЬНЫЕ ФУНКЦИИ КЛИКЕРА И РАБОТЫ С DOM
// =================================================================
...
// =================================================================
// 5. ЗАПОЛНЕНИЕ ПОЛЕЙ И ПАЙПЛАЙН АВТОКЛИКА (/additem)
// =================================================================
...
// =================================================================
// 6. ИНИЦИАЛИЗАЦИЯ (ТОЧКА ВХОДА)
// =================================================================
(function initModule() {
    // 1. Запускаем слежение за кнопкой в каталоге
    initCatalogButtonInjector();

    // 2. Если мы на странице подачи объявления /additem — инициализируем UI и запускаем автокликер
    if (window.location.href.includes('/additem')) {
        ...
        // Автоматически запускаем процесс, если есть невыполненный стек
